...
<?php if (have_posts()) : ?><?php while (have_posts()) : the_post(); ?>
		...
		<div class="post-meta">
		  ...
		  <img src="wp-content/themes/dirty-blue2/img/document.png" style="margin:0; padding:0 5px 0 0; border:0; background:transparent; float:left;"/><span class="category1"><?php the_category(', ') ?></span></div>
		</div>
