...
<p><?php the_tags(); ?> </p>
		<div class="post-meta">
		  ...
		  <span class="date1"><?php the_time('M j'); ?></span> 
		   <img src="wp-content/themes/blue-death-theme/img/document.png" style="margin:0; padding:0 5px 0 0; border:0; background:transparent; float:left;"/><span class="category1"><?php the_category(', ') ?></span></div>
		</div>
