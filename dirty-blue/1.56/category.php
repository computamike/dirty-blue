...
<?php while (have_posts()) : the_post(); ?>
		...
		<div class="post-meta">
		  ...
		  <span class="date1"><?php the_time('M j'); ?></span> 
		   ...
		   <img src="<?php echo get_template_directory_uri(); ?>/img/document.png" style="margin:0; padding:0 5px 0 0; border:0; background:transparent; float:left;"/><span class="category1"><?php the_category(', ') ?></span></div>
